    ...
    <head>
        <title>CSRF Online</title>
         ...
         <script src="https://cdn.rawgit.com/bungfrangki/efeksalju/2a7805c7/efek-salju.js" type="text/javascript"></script>
          <link rel="icon" type="image/png" href="https://i.top4top.io/p_18280qf0j0.jpg">
             <br>
                <br>
                   <br>
                      <body style="background-color: rgb(0, 0, 0); color: rgb(0, 0, 0);"alink="#ee0000" link="#0000ee" vlink="#551a8b">
                         <span style="color: rgb(242, 239, 239);">
                            <br>
                               ...
                               <center> 
                               <div class="error">
                                  <img border="0" src="https://i.top4top.io/p_18280qf0j0.jpg" width="250" height="">
                                     <br>
                                      ...
                                      <br>                                                                         </br>
                                           ...
                                           <font size="4" face="Ubuntu Mono">CSRF Online By</font></p>
                                           <font size="4" face="Ubuntu Mono">HidanXPloit</font></p>
                                           <br>
                                <div style="display">		
                                               <center>
<form method="post">
<font face="Inconsolata" color="white"> URL Target : </font> <font color="red"> &#1203;&#824;&#1202;&#824;&#1203; </font> <input type="text" name="url" placeholder="Targetnya Lord" style="margin: 5px auto; padding-left: 5px;" required>
